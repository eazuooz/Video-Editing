...
> 2026-09-17 용량 정리: 다운로드·임시 렌더·중복 믹스·이전 MP4 267개(약 5.09GB)를 삭제했습니다. 출력은 최종 v3와 한영 SRT를 유지하며, 편집 소스·음성·게임 컷·Git 압축본도 보존했습니다. 아래 과거 v1/v2 MP4 경로는 현재 로컬에 없습니다. [삭제/복구 기록](maintenance/README.md).
