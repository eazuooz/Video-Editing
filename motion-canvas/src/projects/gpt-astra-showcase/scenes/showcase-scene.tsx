...
export function* showcaseScene(view:View2D,index:number){
  ...
  // Asset loading does not consume timeline time; preserve complete video lengths.
  if(scene.duration>example)yield* explanation(view,index,scene.duration-example+(example===0?1/60:0));
}
