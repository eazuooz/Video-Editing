...
Three code variants per entry:
  - "how":         engine-agnostic C++-flavored pseudocode
  - "unity_cs":    Unity (C#), MonoBehaviour Start()/Update() lifecycle
  - "unreal_cpp":  Unreal (C++), AActor BeginPlay()/Tick() lifecycle
"""
