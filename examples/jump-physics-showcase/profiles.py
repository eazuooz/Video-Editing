...
DEFAULT_VX = 1.6  # forward speed used for segments with no game-specific horizontal design
...
def celeste_variable_jump(hold_time, v0=4.24, g_rise=3.0, g_cut=20.0, g_fall=8.0):
    ...
    return height, xpos, total, peak


def celeste_pair():
    tall_h, tall_x, tall_total, tall_peak = celeste_variable_jump(hold_time=1.5)
    short_h, short_x, short_total, short_peak = celeste_variable_jump(hold_time=0.32)
    return (
        Profile(
            key="celeste_full",
